...
Para terminar de desentrañar este asunto, además, habría que investigar si la distribución de las `pct_pt`\~`transfer_n` en es distinta en cada región (queda pendiente que lo verifiquen).
:::
